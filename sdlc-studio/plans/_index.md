...
| ID | Story | Title | Status | Approach | Created |
|----|-------|-------|--------|----------|---------|
...
| [PL0005](PL0005-docker-monitor.md) | [US0005](../stories/US0005-docker-monitor.md) | Docker Container Monitor | Draft | TDD | 2026-02-11 |

## Notes

- Plans are numbered globally (PL0001, PL0002, etc.)
- Plan ID typically matches story number but may diverge
