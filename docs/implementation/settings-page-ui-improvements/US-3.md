...
Story: As a Administrator, I want use existing Ultron design tokens and components by default, and any external UI asset is allowed only if it remains lightweight and does not degrade Raspberry Pi performance, so that the workflow remains reliable and traceable.
Trace: FR-3, AC-3
...
- Interface: src/contracts/fr-3-the-system-must-use-existing-ult.js
- Test stub: tests/settings-page-ui-improvements/generated/tc-3-validate-us-3-primary-behavior.test.mjs

## 5. Dependency Notes
- Order rationale: Implement after US-2
