...
Story: As a maintainer, I want every markdown file classified with rationale and owner, so that document lifecycle is explicit.
Trace: FR-1, AC-1
...
- TC-11: Validate TC-11 (Trace FR: FR-1)
- TC-12: Validate TC-12 (Trace FR: FR-1)

## 4. Scaffold References
- Interface: src/contracts/fr-1-the-system-must-enforce-a-docume.js
- Test stub: tests/total-stabilization/generated/tc-7-validate-tc-7-behavior.test.mjs

## 5. Dependency Notes
- Order rationale: Implement after US-3, US-5, US-1, US-4
