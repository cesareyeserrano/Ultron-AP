...
// TC-LD-004h
func TestVendor_RaspberryPi(t *testing.T) {
	v := Vendor("b8:27:eb:11:22:33")
	assert.Contains(t, strings.ToLower(v), "raspberry pi")
}

// TC-LD-004f
func TestVendor_LAABitReturnsLocallyAdministered(t *testing.T) {
...
// TC-LD-004e
func TestVendor_UnknownPrefixReturnsUnknown(t *testing.T) {
...
func TestVendor_NoNetworkLookups(t *testing.T) {
...
func TestVendor_MalformedInputs(t *testing.T) {
