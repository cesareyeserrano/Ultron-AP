...
export async function fr_1_the_system_must_provide_a_complete_mobile_fir(input) {
  ...
  const checks = [
    ...
    ["mobile-first compact grid exists", html.includes("grid grid-cols-1 lg:grid-cols-[220px_1fr]")],
    ["section navigation markers exist", html.includes("data-settings-nav")],
